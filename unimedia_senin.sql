...
--
-- Host: 127.0.0.1
-- Generation Time: May 03, 2021 at 05:15 PM
...
--
-- Table structure for table `produk36371`
--

CREATE TABLE `produk36371` (
  `id36371` int(11) NOT NULL,
  `nama36371` varchar(50) NOT NULL,
  `model36371` varchar(50) NOT NULL,
  `harga_beli36371` double NOT NULL,
  `harga_jual36371` double NOT NULL,
  `stok36371` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `produk36371`
--

INSERT INTO `produk36371` (`id36371`, `nama36371`, `model36371`, `harga_beli36371`, `harga_jual36371`, `stok36371`) VALUES
(1, 'Mobil', 'X', 15.5, 14.5, 1);
...
--
-- Indexes for table `produk36371`
--
ALTER TABLE `produk36371`
  ADD PRIMARY KEY (`id36371`);
...
--
-- AUTO_INCREMENT for table `produk36371`
--
ALTER TABLE `produk36371`
  MODIFY `id36371` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
